...
from neuropype.nodes.feature_extraction import IncrementalPrincipalComponentAnalysis
...
class OWIncrementalPrincipalComponentAnalysis(widget.OWWidget):
    ...
    def __init__(self):
        ...
        self.node = IncrementalPrincipalComponentAnalysis()
        ...
        self.whiten_control = gui.checkBox(box, self, 'whiten', 'Whiten', callback=lambda: self.property_changed('whiten'), tooltip="Normalize (whiten) outputs.")
        self.batch_size_control = gui.lineEdit(box, self, 'batch_size', 'Batch size:', orientation='horizontal', enterPlaceholder=True, callback=lambda: self.property_changed('batch_size'), tooltip="Batch size. Optionally the number of samples to use for each mini-batch.")
    ...
    def reset_default_properties(self, names=None):
        node = IncrementalPrincipalComponentAnalysis()
...
if __name__ == '__main__':
    ...
    ow = OWIncrementalPrincipalComponentAnalysis()
    ow.show()
    app.exec_()