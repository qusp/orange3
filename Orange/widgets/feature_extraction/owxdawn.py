...
class OWXDAWN(cpewidget.CPEWidget):
    ...
    def __init__(self):
        ...
        self.erp_duration_control = gui.lineEdit(box, self, 'erp_duration', label='Erp duration:', orientation='horizontal', callback=lambda: self.property_changed('erp_duration'), tooltip="Duration of the stimulus-evoked activity, in seconds.")
        self.num_components_control = gui.lineEdit(box, self, 'num_components', label='Num components:', orientation='horizontal', callback=lambda: self.property_changed('num_components'), tooltip="Number of xDAWN components to retain.")
