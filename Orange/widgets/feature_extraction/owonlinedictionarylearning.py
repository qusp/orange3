...
class OWOnlineDictionaryLearning(widget.OWWidget):
    ...
    def __init__(self):
        ...
        self.batch_size_control = gui.lineEdit(box, self, 'batch_size', 'Batch size:', orientation='horizontal', enterPlaceholder=True, callback=lambda: self.property_changed('batch_size'), tooltip="Number of samples in each mini-batch.")
        ...
        self.shuffle_control = gui.checkBox(box, self, 'shuffle', 'Shuffle', callback=lambda: self.property_changed('shuffle'), tooltip="Shuffle samples before forming batches.")
