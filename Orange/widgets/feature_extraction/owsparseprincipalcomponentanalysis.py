...
class OWSparsePrincipalComponentAnalysis(widget.OWWidget):
    ...
    def __init__(self):
        ...
        self.node = SparsePrincipalComponentAnalysis()
        ...
        self.ridge_alpha_control = gui.lineEdit(box, self, 'ridge_alpha', 'Ridge alpha:', orientation='horizontal', enterPlaceholder=True, callback=lambda: self.property_changed('ridge_alpha'))
        ...
        self.method_control = gui.lineEdit(box, self, 'method', 'Method:', orientation='horizontal', enterPlaceholder=True, callback=lambda: self.property_changed('method'))
    ...
    def reset_default_properties(self, names=None):
        node = SparsePrincipalComponentAnalysis()
...
if __name__ == '__main__':
    ...
    ow = OWSparsePrincipalComponentAnalysis()
    ow.show()
    app.exec_()