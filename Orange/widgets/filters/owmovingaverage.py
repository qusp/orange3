...
class OWMovingAverage(widget.OWWidget):
    ...
    def __init__(self):
        ...
        self.order_control = gui.lineEdit(box, self, 'order', 'Order:', orientation='horizontal', enterPlaceholder=True, callback=lambda: self.property_changed('order'), tooltip="Filter order in samples. Default: 100.")
