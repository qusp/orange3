...
class OWSpatioSpectralDecomposition(widget.OWWidget):
    ...
    def __init__(self):
        ...
        self.node = SpatioSpectralDecomposition()
        ...
        self.streaming_update_control = gui.checkBox(box, self, 'streaming_update', 'Streaming update', callback=lambda: self.property_changed('streaming_update'))
        self.half_time_control = gui.lineEdit(box, self, 'half_time', 'Half time:', orientation='horizontal', enterPlaceholder=True, callback=lambda: self.property_changed('half_time'))
    ...
    def reset_default_properties(self, names=None):
        node = SpatioSpectralDecomposition()
...
if __name__ == '__main__':
    ...
    ow = OWSpatioSpectralDecomposition()
    ow.show()
    app.exec_()