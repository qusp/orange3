...
class OWDelayEmbedding(widget.OWWidget):
    ...
    def __init__(self):
        ...
        self.lags_control = gui.lineEdit(box, self, 'lags', 'Lags:', orientation='horizontal', enterPlaceholder=True, callback=lambda: self.property_changed('lags'))
