...
class OWCovariance(cpewidget.CPEWidget):
    ...
    def __init__(self):
        ...
        self.cov_axis_control = gui.comboBox(box, self, 'cov_axis', label='Cov axis:', items=('instance', 'statistic', 'time', 'lag', 'feature', 'space', 'frequency', 'axis'), sendSelectedValue=True, orientation='horizontal', callback=lambda: self.property_changed('cov_axis'), tooltip="Axis to take covariance of. This is a string that identifies the axis to use (e.g. 'time', 'space', 'frequency', 'instance', 'feature', ...).")
        self.avg_axis_control = gui.comboBox(box, self, 'avg_axis', label='Avg axis:', items=('instance', 'statistic', 'time', 'lag', 'feature', 'space', 'frequency', 'axis'), sendSelectedValue=True, orientation='horizontal', callback=lambda: self.property_changed('avg_axis'), tooltip="Axis to average over. This is a string that identifies the axis to use (e.g. 'time', 'space', 'frequency', 'instance', 'feature', ...).")
