...
class OWConcatInputs(cpewidget.CPEWidget):
    ...
    def __init__(self):
        ...
        self.axis_control = gui.comboBox(box, self, 'axis', label='Axis:', items=('statistic', 'time', 'instance', 'axis', 'lag', 'feature', 'space', 'frequency'), sendSelectedValue=True, orientation='horizontal', callback=lambda: self.property_changed('axis'), tooltip="New axis type to fold into.")
