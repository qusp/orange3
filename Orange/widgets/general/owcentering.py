...
from neuropype.nodes.general import Centering


class OWCentering(widget.OWWidget):
    name = "Centering"
    description = "Center the given data values."
    author = "Christian Kothe"
    icon = "icons/Centering.svg"
    priority = 2
    category = "General"
    ...
    def __init__(self):
        ...
        self.robust_control = gui.checkBox(box, self, 'robust', 'Robust', callback=lambda: self.property_changed('robust'))
