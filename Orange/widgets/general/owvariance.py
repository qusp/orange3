...
from neuropype.nodes.general import Variance


class OWVariance(cpewidget.CPEWidget):
    ...
    def __init__(self):
        ...
        self.axis_control = gui.lineEdit(box, self, 'axis', 'Axis:', orientation='horizontal', enterPlaceholder=True, callback=lambda: self.property_changed('axis'), tooltip="Axis across which to take the variance. This is a string that identifies the axis to use (e.g. 'instance', 'time', 'frequency').")
