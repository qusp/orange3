...
class OWAssignTargets(cpewidget.CPEWidget):
    ...
    def __init__(self):
        ...
        self.mapping_control = gui.lineEdit(box, self, 'mapping', label='Mapping:', orientation='horizontal', callback=lambda: self.property_changed('mapping'), tooltip="Target value mapping. A Python dict that maps from marker payload (or label) to numeric target value. Syntax is: {'key': value, 'key', value, ...}")
