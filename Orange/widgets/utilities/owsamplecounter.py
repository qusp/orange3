...
class OWSampleCounter(widget.OWWidget):
    name = 'Count Samples'
    ...
    def __init__(self):
        ...
        self.enabled_control = gui.checkBox(box, self, 'enabled', 'Enabled', callback=lambda: self.property_changed('enabled'))
