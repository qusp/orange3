...
from neuropype.nodes.elementwise import Magnitude


class OWMagnitude(cpewidget.CPEWidget):

    # Node meta-data.
    name = "Complex Magnitude"
    description = "Complex magnitude of given data."
    author = "Christian Kothe"
    icon = "icons/Magnitude.svg"
    priority = 5
