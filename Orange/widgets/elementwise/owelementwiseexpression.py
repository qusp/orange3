...
class OWElementwiseExpression(cpewidget.CPEWidget):
    ...
    def __init__(self):
        ...
        self.expression_control = gui.lineEdit(box, self, 'expression', label='Expression:', orientation='horizontal', callback=lambda: self.property_changed('expression'), tooltip="Expression to apply. The data is referred to as x.")
