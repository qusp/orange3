...
class OWSigmoid(widget.OWWidget):
    name = 'Sigmoid'
    ...
    def __init__(self):
        ...
        self.pre_shift_control = gui.lineEdit(box, self, 'pre_shift', 'Pre shift:', orientation='horizontal', enterPlaceholder=True, callback=lambda: self.property_changed('pre_shift'))
        self.pre_scale_control = gui.lineEdit(box, self, 'pre_scale', 'Pre scale:', orientation='horizontal', enterPlaceholder=True, callback=lambda: self.property_changed('pre_scale'))
        self.post_scale_control = gui.lineEdit(box, self, 'post_scale', 'Post scale:', orientation='horizontal', enterPlaceholder=True, callback=lambda: self.property_changed('post_scale'))
        self.post_shift_control = gui.lineEdit(box, self, 'post_shift', 'Post shift:', orientation='horizontal', enterPlaceholder=True, callback=lambda: self.property_changed('post_shift'))
