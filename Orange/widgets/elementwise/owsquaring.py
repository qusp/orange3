...
from neuropype.nodes.elementwise import Squaring


class OWSquaring(cpewidget.CPEWidget):

    # Node meta-data.
    name = "Squaring"
    description = "Square numeric values."
    author = "Christian Kothe"
    icon = "icons/Squaring.svg"
    priority = 18
