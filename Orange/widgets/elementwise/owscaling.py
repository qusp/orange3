...
class OWScaling(cpewidget.CPEWidget):
    ...
    def __init__(self):
        ...
        self.factor_control = gui.lineEdit(box, self, 'factor', label='Factor:', orientation='horizontal', callback=lambda: self.property_changed('factor'), tooltip="Rescaling factor.")
