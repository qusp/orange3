...
from neuropype.nodes.elementwise import Reciprocal


class OWReciprocal(widget.OWWidget):
    name = 'Reciprocal'
    description = 'Take the reciprocal of the given values.'
    author = 'Christian Kothe'
    icon = 'icons/Reciprocal.svg'
    priority = 11
