...
class OWShift(cpewidget.CPEWidget):
    ...
    def __init__(self):
        ...
        self.offset_control = gui.lineEdit(box, self, 'offset', label='Offset:', orientation='horizontal', callback=lambda: self.property_changed('offset'), tooltip="Shift offset.")
