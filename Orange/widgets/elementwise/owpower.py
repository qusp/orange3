...
class OWPower(cpewidget.CPEWidget):
    ...
    def __init__(self):
        ...
        self.power_control = gui.lineEdit(box, self, 'power', label='Power:', orientation='horizontal', callback=lambda: self.property_changed('power'), tooltip="Power coefficient.")
