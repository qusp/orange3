...
from neuropype.nodes.elementwise import SquareRoot


class OWSquareRoot(widget.OWWidget):
    name = 'Square Root'
    description = 'Square root of numeric values.'
    author = 'Christian Kothe'
    icon = 'icons/SquareRoot.svg'
    priority = 17
