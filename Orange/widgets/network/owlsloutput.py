...
class OWLSLOutput(cpewidget.CPEWidget):
    ...
    def __init__(self):
        ...
        self.source_id_control = gui.lineEdit(box, self, 'source_id', label='Source id:', orientation='horizontal', callback=lambda: self.property_changed('source_id'), tooltip="Source ID of the node. This should be a unique identifier, ideally persistent.")
