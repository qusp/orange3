...
class OWSpectralSelection(cpewidget.CPEWidget):
    ...
    def __init__(self):
        ...
        self.frequencies_control = gui.lineEdit(box, self, 'frequencies', label='Frequencies:', orientation='horizontal', callback=lambda: self.property_changed('frequencies'), tooltip="Frequency-domain selection, given as a list of [low, high] frequency band edges.")
