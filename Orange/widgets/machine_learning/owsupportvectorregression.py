...
class OWSupportVectorRegression(cpewidget.CPEWidget):
    ...
    def __init__(self):
        ...
        super().__init__(SupportVectorRegression())
        ...
        self.epsilon_control = gui.lineEdit(box, self, 'epsilon', label='Epsilon:', orientation='horizontal', callback=lambda: self.property_changed('epsilon'), tooltip="Width of the epsilon tube.")
