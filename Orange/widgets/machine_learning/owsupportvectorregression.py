...
class OWSupportVectorRegression(cpewidget.CPEWidget):
    ...
    def __init__(self):
        ...
        self.epsilon_control = gui.lineEdit(box, self, 'epsilon', 'Epsilon:', orientation='horizontal', enterPlaceholder=True, callback=lambda: self.property_changed('epsilon'), tooltip="Width of the epsilon tube.")
