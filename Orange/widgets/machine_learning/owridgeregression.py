...
class OWRidgeRegression(cpewidget.CPEWidget):
    ...
    def __init__(self):
        ...
        self.alphas_control = gui.lineEdit(box, self, 'alphas', label='Alphas:', orientation='horizontal', callback=lambda: self.property_changed('alphas'), tooltip="List of regularization strengths. The optimal value is selected based on cross-validation. Larger values cause stronger regularization.")
