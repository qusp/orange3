...
class OWLogisticRegression(cpewidget.CPEWidget):
    ...
    def __init__(self):
        ...
        self.alphas_control = gui.lineEdit(box, self, 'alphas', label='Alphas:', orientation='horizontal', callback=lambda: self.property_changed('alphas'), tooltip="Regularization strength. Larger values cause stronger regularization (Note for scikit-learn users: this is the inverse of C in logreg).")
